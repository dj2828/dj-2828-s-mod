...
public class PortafoglioMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PortafoglioMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(DjModModMenus.PORTAFOGLIO_GUI, id);
