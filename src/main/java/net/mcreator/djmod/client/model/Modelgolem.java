...
public class Modelgolem<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dj_mod", "modelgolem"), "main");
	public final ModelPart gambasx;
	public final ModelPart gambadx;
	public final ModelPart busto;
	public final ModelPart testa;
	public final ModelPart manodx;
	public final ModelPart manosx;
