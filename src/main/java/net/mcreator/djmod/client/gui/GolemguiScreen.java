...
public class GolemguiScreen extends AbstractContainerScreen<GolemguiMenu> {
	private final static HashMap<String, Object> guistate = GolemguiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public GolemguiScreen(GolemguiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("dj_mod:textures/screens/golemgui.png");
